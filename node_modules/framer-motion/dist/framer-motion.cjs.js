...
var buildStyleAttr = function (values, styleProp, isStatic) {
    ...
    return tslib_1.__assign({}, styleProp, styler.buildStyleProperty(motionValueStyles, !isStatic));
};
...
function createDomMotionConfig(Component) {
    ...
    return {
        renderComponent: function (ref, style, values, props, isStatic) {
            ...
            return React.createElement(Component, tslib_1.__assign({}, forwardProps, { ref: ref }, staticVisualStyles));
        },
        /**
