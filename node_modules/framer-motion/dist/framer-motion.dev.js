(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var alpha$1 = __assign$3({}, number$1, { transform: clamp$2(0, 1) });
    var scale$1 = __assign$3({}, number$1, { default: 1 });
    ...
    var progressPercentage$1 = __assign$3({}, percent$1, { parse: function (v) { return percent$1.parse(v) / 100; }, transform: function (v) { return percent$1.transform(v * 100); } });
    ...
    var rgbUnit$1 = __assign$3({}, number$1, { transform: function (v) { return Math.round(clampRgbUnit$1(v)); } });
    ...
    var hex$1 = __assign$3({}, rgba$1, { test: function (v) { return typeof v === 'string' && isColorString$1(v, '#'); }, parse: function (v) {
            var r = '';
            var g = '';
            var b = '';
            if (v.length > 4) {
    ...
    ***************************************************************************** */
    ...
    var int = /*#__PURE__*/__assign$4({}, number$1, { transform: Math.round });
    var valueTypes = {
        color: color$1,
    ...
    function createCssStyler(element, _a) {
        ...
        return cssStyler(__assign$4({ element: element, buildStyles: createStyleBuilder(enableHardwareAcceleration), preparseOutput: true }, props));
    }
     ...
     * @beta
     */
    var useInvertedScale = function (scale) {
